...
[![godoc reference](https://pkg.go.dev/badge/github.com/aluxian/mtproto?status.svg)](https://pkg.go.dev/github.com/aluxian/mtproto)
[![Go Report Card](https://goreportcard.com/badge/github.com/aluxian/mtproto)](https://goreportcard.com/report/github.com/aluxian/mtproto)
[![codecov](https://codecov.io/gh/xelaj/mtproto/branch/master/graph/badge.svg)](https://codecov.io/gh/xelaj/mtproto)
[![license MIT](https://img.shields.io/badge/license-MIT-green)](https://github.com/aluxian/mtproto/blob/main/README.md)
...
**english** [русский](https://github.com/aluxian/mtproto/blob/main/docs/ru_RU/README.md) [简体中文](https://github.com/aluxian/mtproto/blob/main/docs/zh_CN/README.md)
...
**Code examples are [here](https://github.com/aluxian/mtproto/blob/main/examples)**

**Full docs are [here](https://pkg.go.dev/github.com/aluxian/mtproto)**
...
**Example [here](https://github.com/aluxian/mtproto/blob/main/examples/auth)**
...
Want to deal those freaky `tg://` links? See [`deeplinks` package](https://github.com/aluxian/mtproto/blob/main/telegram/deeplinks), here is the simplest how-to:
...
import (
    ...
    "github.com/aluxian/mtproto/telegram/deeplinks"
)
...
Please read [contributing guide](https://github.com/aluxian/mtproto/blob/main/.github/CONTRIBUTING.md) if you want to help. And the help is very necessary!

**Don't want code?** Read [this](https://github.com/aluxian/mtproto/blob/main/.github/SUPPORT.md) page! We love nocoders!

## Security bugs?

Please, don't create issue which is describe security bug, this can be too offensive! Instead, please read [this notifiaction](https://github.com/aluxian/mtproto/blob/main/.github/SECURITY.md) and follow that steps to notify us about problem.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/aluxian/mtproto/blob/main/LICENSE.md) file for details
