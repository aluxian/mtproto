...
[![license MIT](https://img.shields.io/badge/license-MIT-green)](https://github.com/aluxian/mtproto/blob/master/README.md)
...
[english](https://github.com/aluxian/mtproto/blob/main/README.md) **русский** [简体中文](https://github.com/aluxian/mtproto/blob/main/docs/zh_CN/README.md)
...
**Примеры кода [здесь](https://github.com/aluxian/mtproto/blob/master/examples)**

**Полная документация [здесь](https://pkg.go.dev/github.com/aluxian/mtproto)**
...
**Пример [здесь](https://github.com/aluxian/mtproto/blob/master/examples/auth)**
...
Нужно работать с этими стрёмными `tg://` ссылками? Загляните в [пакет `deeplinks`](https://github.com/aluxian/mtproto/blob/main/telegram/deeplinks), вот самый простейший пример:
...
Please read [contributing guide](https://github.com/aluxian/mtproto/blob/master/doc/en_US/CONTRIBUTING.md) if you want to help. And the help is very necessary!


## Критические уязвимости?

Ага, мы стараемся подходить к ним серьезно. Пожалуйста, не создавайте ищью, описывающие ошибку безопасности, это может быть ОЧЕНЬ небезопасно! Вместо этого рекомендуем глянуть на [эту страничку](https://github.com/aluxian/mtproto/blob/main/.github/SECURITY.md) и следовать инструкции по уведомлению.
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/aluxian/mtproto/blob/master/doc/en_US/LICENSE.md) file for details
